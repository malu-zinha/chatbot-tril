-- =====================================================
-- CRIAR VIEWS DO DASHBOARD - SCRIPT LIMPO
-- =====================================================
...
-- VIEW 6: Retrabalho por Engenheiro (simplificada)
...
SELECT 
    ...
    ROUND(COALESCE(AVG(
        CASE WHEN r.necessitou_retrabalho = true THEN 100 ELSE 0 END
    ), 0), 2) AS retrabalho_medio_percentual,
    COUNT(DISTINCT ep.projeto_id) FILTER (
        WHERE EXISTS (
